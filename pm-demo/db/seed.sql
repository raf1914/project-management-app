...
INSERT INTO tasks (id, projectId, title, description, status, priority, assignee, estimateHours, dueDate, createdAt) VALUES
  ...
  ('t-3',  'p-1', 'Build component library',
  ...
  -- Mobile App v2
  ('t-7',  'p-2', 'Offline data sync spike',
  ...
  ('t-8',  'p-2', 'Redesign onboarding flow',
  ...
  ('t-9',  'p-2', 'Implement push notifications',
  ...
  ('t-10', 'p-2', 'Beta release checklist',
  ...
  -- Q3 Marketing Launch
  ('t-11', 'p-3', 'Draft launch messaging',
  ...
  ('t-12', 'p-3', 'Coordinate with design',
...
INSERT INTO timeLogs (id, taskId, author, hours, date, note, createdAt) VALUES
  ('tl-1', 't-3', 'Mateo Rivera', 4,   '2026-06-01', 'Button and badge components, base layout tokens.',        '2026-06-01T17:00:00.000Z'),
  ('tl-2', 't-3', 'Mateo Rivera', 3.5, '2026-06-03', 'Input and select field variants.',                       '2026-06-03T18:00:00.000Z'),
  ('tl-3', 't-8', 'Lena Walsh',   3,   '2026-06-04', 'Merged profile and preferences screens into one step.',  '2026-06-04T16:30:00.000Z'),
  ('tl-4', 't-4', 'Mateo Rivera', 5,   '2026-06-05', 'Initial landing page port to component library.',        '2026-06-05T17:00:00.000Z');
